...
Setup
---------
Configuring the github-merge tool for the TSCB repository is done in the following way:

    git config githubmerge.repository TSCB-Project/TSCB
...
A script to optimize png files in the TSCB
