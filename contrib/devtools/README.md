...
Setup
---------
Configuring the github-merge tool for the AIS repository is done in the following way:

    git config githubmerge.repository AIS-Project/AIS
...
A script to optimize png files in the AIS
