...
Setup
---------
Configuring the github-merge tool for the TSC repository is done in the following way:

    git config githubmerge.repository TSC-Project/TSC
...
A script to optimize png files in the TSC
