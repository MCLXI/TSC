                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received TSCB from zTSCB"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTSCB"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTSCB));
