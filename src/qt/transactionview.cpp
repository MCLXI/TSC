                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Aisport from zAisport"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAisport"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAisport));
