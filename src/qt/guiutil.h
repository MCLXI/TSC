...
/** Utility functions used by the Somnio Qt UI.
 */
namespace GUIUtil
{
...
// Render Somnio addresses in monospace font
...
// Parse "somnio:" URI into recipient object, return true on successful parsing
