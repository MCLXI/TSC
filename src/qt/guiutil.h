...
/** Utility functions used by the Aisport Qt UI.
 */
namespace GUIUtil
{
...
// Render Aisport addresses in monospace font
...
// Parse "aisport:" URI into recipient object, return true on successful parsing
