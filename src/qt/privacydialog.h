...
public:
    ...
    void setZTSCBControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzTSCB_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzTSCB_clicked();
    void on_pushButtonZTSCBControl_clicked();
