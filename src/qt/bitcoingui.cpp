                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TSCB Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TSCB address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and TSCB: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTSCB"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TSCB Core"), this);
    aboutAction->setStatusTip(tr("Show information about TSCB Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TSCB"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TSCB addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TSCB addresses"));
    ...
    openAction->setStatusTip(tr("Open a TSCB: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TSCB Core help message to get a list with possible TSCB command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TSCB Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TSCB network", "", count));
}
...
{
    QString strTitle = tr("TSCB Core"); // default title
