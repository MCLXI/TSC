                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Aisport Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Aisport address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aisport: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAIS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Aisport Core"), this);
    aboutAction->setStatusTip(tr("Show information about Aisport Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Aisport"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Aisport addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Aisport addresses"));
    ...
    openAction->setStatusTip(tr("Open a Aisport: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Aisport Core help message to get a list with possible Aisport command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Aisport Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Aisport network", "", count));
}
...
{
    QString strTitle = tr("Aisport Core"); // default title
