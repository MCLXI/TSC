                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TSC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TSC Core"), this);
    aboutAction->setStatusTip(tr("Show information about TSC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TSC"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the TSC Core help message to get a list with possible TSC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TSC Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("TSC Core"); // default title
