                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Somnio Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Somnio address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and somnio: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSMN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Somnio Core"), this);
    aboutAction->setStatusTip(tr("Show information about Somnio Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Somnio"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Somnio addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Somnio addresses"));
    ...
    openAction->setStatusTip(tr("Open a Somnio: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Somnio Core help message to get a list with possible Somnio command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Somnio Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Somnio network", "", count));
}
...
{
    QString strTitle = tr("Somnio Core"); // default title
