/* src/config/aisport-config.h.  Generated from aisport-config.h.in by configure.  */
/* src/config/aisport-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AISPORT_CONFIG_H

#define AISPORT_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.aisport.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Aisport Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Aisport Core 2.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "aisport"
