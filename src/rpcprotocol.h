...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Aisport is not connected
    ...
    RPC_WALLET_PASSAISASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
