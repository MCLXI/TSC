...
In order to support loading of multiple wallets in somnio-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is somnio.cpp.
...
Changes to somnio.cpp
----------------------
somnio.cpp is the entry point into somnio-qt, and as such, will require some minor modifications to provide hooks for
