...
In order to support loading of multiple wallets in TSCB-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is TSCB.cpp.
...
Changes to TSCB.cpp
----------------------
TSCB.cpp is the entry point into TSCB-qt, and as such, will require some minor modifications to provide hooks for
