...
In order to support loading of multiple wallets in aisport-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aisport.cpp.
...
Changes to aisport.cpp
----------------------
aisport.cpp is the entry point into aisport-qt, and as such, will require some minor modifications to provide hooks for
