...
In order to support loading of multiple wallets in TSC-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is TSC.cpp.
...
Changes to TSC.cpp
----------------------
TSC.cpp is the entry point into TSC-qt, and as such, will require some minor modifications to provide hooks for
