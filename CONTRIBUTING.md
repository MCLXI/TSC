Contributing to TSC Core
============================

The TSC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TSC Core project, and is not to be
confused with overall TSC Network Protocol consensus changes.

Whether a pull request is merged into TSC Core rests with the project merge
...
Patches that change TSC consensus rules are considerably more involved than
...
Where a patch set proposes to change the TSC consensus, it must have been
...
The project leader is the release manager for each TSC Core release.
