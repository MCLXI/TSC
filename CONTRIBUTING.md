Contributing to TSCB Core
============================

The TSCB Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TSCB Core project, and is not to be
confused with overall TSCB Network Protocol consensus changes.

Whether a pull request is merged into TSCB Core rests with the project merge
...
Patches that change TSCB consensus rules are considerably more involved than
...
Where a patch set proposes to change the TSCB consensus, it must have been
...
The project leader is the release manager for each TSCB Core release.
