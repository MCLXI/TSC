Contributing to Somnio Core
============================

The Somnio Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Somnio Core project, and is not to be
confused with overall Somnio Network Protocol consensus changes.

Whether a pull request is merged into Somnio Core rests with the project merge
...
Patches that change Somnio consensus rules are considerably more involved than
...
Where a patch set proposes to change the Somnio consensus, it must have been
...
The project leader is the release manager for each Somnio Core release.
