Contributing to Aisport Core
============================

The Aisport Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Aisport Core project, and is not to be
confused with overall Aisport Network Protocol consensus changes.

Whether a pull request is merged into Aisport Core rests with the project merge
...
Patches that change Aisport consensus rules are considerably more involved than
...
Where a patch set proposes to change the Aisport consensus, it must have been
...
The project leader is the release manager for each Aisport Core release.
